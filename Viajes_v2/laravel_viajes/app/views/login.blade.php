...
<div class="login-wrap">
    ...
    {{ Form::open(['route' => 'dashboard', 'method' => 'POST', 'class'=>'form-horizontal']) }}
    <div class="metro double-size green">
            <div class="input-append lock-input">
                {{ Form::email('email','',['class'=>'', 'placeholder'=>'Correo Electronico']) }}
            </div>
    </div>
    <div class="metro double-size yellow">
            <div class="input-append lock-input">
                {{ Form::password('clave','',['class'=>'', 'placeholder'=>'Clave']) }}
            </div>
    </div>
    ...
    <div class="login-footer">
        ...
        <div class="forgot-hint pull-right">
            <a id="forget-password" class="" href="javascript:;">¿Olvidaste tu clave?</a>
        </div>
    </div>
</div>
</body>
